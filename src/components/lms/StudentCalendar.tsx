...
// StudentCalendar — SLM-010 학생 월별 캘린더 그리드 (교수 ProfessorCalendar와 소유경계 분리)
// - 강의 일정 + 과제 마감 이벤트를 날짜 셀에 표시. 색상만 역할 theme로 주입(에메랄드).
...
export default function StudentCalendar({ year, month, events, theme, loading, onPrev, onNext }: Props) {
