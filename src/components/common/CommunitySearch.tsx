...
function PostResultCard({
  ...
  return (
    <button
      onClick={() => router.push(boardHref[post.postId] ?? "/community")}
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 rounded-2xl border border-border bg-white p-2 shadow-sm focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20">
            ...
            <button
              ...
              className="rounded-xl bg-primary px-5 py-2 text-sm font-bold text-white shadow-sm transition-colors hover:bg-teal-600"
            >
              검색
            </button>
          </div>
        ...
        {keyword && (
          <>
            ...
            {showPosts && filteredPosts.length > 0 && (
              <div className="mb-6">
                <h3 className="mb-3 text-[13px] font-bold text-slate-400 uppercase tracking-wider">
