    ...
    return (
      <div className="mx-auto max-w-[920px]">
        ...
        <div className="flex flex-col items-center rounded-2xl border border-border bg-white p-14 text-center shadow-sm">
          ...
          <h2 className="mb-2 mt-4 text-[19px] font-extrabold text-slate-800">
            블라인드 처리된 게시글이에요
          </h2>
          <p className="mx-auto max-w-[360px] text-sm leading-relaxed text-slate-400">
            신고가{" "}
            <b className="text-red-500">{post.reportCount}회</b> 누적되어
            자동으로 가려진 게시글이에요. 열람이 제한됩니다.
          </p>
      ...
      <div className="mx-auto max-w-[920px]">
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-white shadow-sm">
          <div className="p-6">
            ...
            {/* 제목 */}
            <h2 className="mb-4 text-[22px] font-extrabold leading-snug tracking-tight text-slate-900">
              {post.title}
            </h2>
            ...
            {/* 본문 */}
            <p className="my-6 whitespace-pre-line text-[15px] leading-[1.9] text-slate-600">
            ...
            <div className="flex items-center justify-between border-t border-border pt-4">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-full px-3 py-2 text-sm font-medium text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600"
              >
