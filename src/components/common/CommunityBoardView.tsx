...
const BOARD_META: Record<BoardType, {
  ...
  free: {
    ...
    headerBg: 'bg-gradient-to-br from-teal-900/25 via-teal-700/10 to-teal-100 border-teal-900/20',
  ...
  secret: {
    ...
    headerBg: 'bg-gradient-to-br from-slate-300 via-slate-100 to-white border-slate-300',
    iconBg: 'bg-slate-100',
  ...
  notice: {
    ...
    headerBg: 'bg-gradient-to-br from-blue-950/25 via-blue-800/10 to-blue-100 border-blue-950/20',
    iconBg: 'bg-primary/5',
    badgeBg: 'bg-primary/10 text-primary',
    accentText: 'text-primary',
  },
