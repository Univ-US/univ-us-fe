                                    ...
                                    return (
                                        <div key={item.messageId} className={`flex ${mine ? "justify-end" : "justify-start"}`}>
                                            <div className={`flex min-w-0 w-fit max-w-[78%] flex-col ${mine ? "items-end" : "items-start"}`} style={{ maxWidth: "78%" }}>
                                                ...
                                                <div className={`min-w-0 max-w-full rounded-2xl px-4 py-3 text-sm font-semibold leading-6 ${mine ? "rounded-br-md bg-primary text-white" : "rounded-bl-md border border-slate-200 bg-white text-slate-800"}`}>
