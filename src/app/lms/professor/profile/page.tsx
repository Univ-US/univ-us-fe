...
export default function ProfessorProfilePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(`저장에 실패했습니다 — ${describeApiError(err)}`);
    } finally {
      setSaving(false);
    }
  };
...
const editableInput =
  "w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-500/30";
